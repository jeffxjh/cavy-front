<template>
    <div id="user">
        ...
        <el-table
            ...
            <el-table-column type="expand" width="100px">
                ...
                <template slot-scope="props">
                    ...
                    <el-pagination background v-if="props.row.childrenData.length > 10"
                                   layout="prev, pager, next, sizes, total, jumper"
                                   :page-sizes="[1, 5, 10, 15]" :page-size="chrild.pageSize" :total="chrild.total"
                                   @current-change="chrildhandleCurrentChange" @size-change="chrildhandleSizeChange">
                    </el-pagination>
                </template>
            </el-table-column>
            <el-table-column prop="name" label="字典名称" :render-header="addRedStar"> </el-table-column>
            <el-table-column prop="code" label="字典编码" :render-header="addRedStar"> </el-table-column>
            ...
            <el-table-column label="操作" width="280">
                <template slot-scope="scope">
                    <el-button :size="btnSize" type="success" @click="handleAddItem(scope.$index, scope.row)">添加项
                    </el-button>
                    <el-button :size="btnSize" type="warning" @click="handleEdit(scope.$index, scope.row)">修改
                    </el-button>
                    <el-button
                               :size="btnSize"
                               type="danger"
        ...
        <el-drawer title="消息列表" :visible.sync="item.drawer" :with-header="false" height="250" max-height="250">
            <div style="padding:20px;border-radius: 4px;border: 2px; border: 1px solid #666; margin: 5px;height: 100%;">
                ...
                <el-table size="mini" :data="item.tempList">
