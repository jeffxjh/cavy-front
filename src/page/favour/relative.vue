...
<template>
  <div id="role">
    <el-breadcrumb separator="/" style="margin-bottom: 10px; font-size: 15px">
      ...
      <el-breadcrumb-item>人情管理</el-breadcrumb-item>
      <el-breadcrumb-item>亲友团</el-breadcrumb-item></el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-table
      ...
      <el-table-column prop="realName" label="亲友名称"> </el-table-column>
      <el-table-column prop="nickName" label="亲友昵称"> </el-table-column>
      <el-table-column prop="relateUserName" label="亲友关联的用户"> </el-table-column>
      <el-table-column prop="relateType" label="亲友关系"> </el-table-column>
      <el-table-column prop="userName" label="谁的亲友"> </el-table-column>
...
<script>
  import { pageFavourRelate, addFavourRelate, delFavourRelate,updateFavourRelate } from "@/common/api/api";
