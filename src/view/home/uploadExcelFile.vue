  ...
  >
    <el-row>
      <div class="el-form-item__content">
        ...
        >
          <el-button size="small" type="primary" @click="downTemplate"
            >下载模板</el-button
          >
          <el-button size="small" type="success">选择文件</el-button>
          <span style="padding-left:5px">{{ resultMessage }}</span>
...
export default {
  ...
  methods: {
    ...
    uploadHttpRequest(param) {
      ...
      postExcelRequest(this.excelUrl, formData)
        .then((res) => {
          this.resultMessage =
            "上传成功：" +
